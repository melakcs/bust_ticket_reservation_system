							...
							while($row = mysql_fetch_array($result))
								{
									...
									echo '<td><div align="right">'.$row['RouteID'].'</div></td>';
									echo '<td><div align="right">'.$row['CustID'].'</div></td>';
									echo '<td><div align="right">'.$row['Date'].'</div></td>';
									echo '<td><div align="right">'.$row['SeatReserve'].'</div></td>';								
									echo '<td><div align="right">'.$row['Route'].'</div></td>';
									echo '<td><div align="right">'.$row['CustFName'].'</div></td>';
									echo '<td><div align="right">'.$row['CustLName'].'</div></td>';
									echo '<td><div align="right">'.$row['CustUName'].'</div></td>';
									echo '<td><div align="right">'.$row['CustIA'].'</div></td>';
									echo '<td><div align="right">'.$row['CustCA'].'</div></td>';
									...
									echo '<td><div align="center"><a rel="facebox"  <a href="#" id="'.$row['ID'].'" class="delbutton" title="Click To Delete">Delete</a></div></td>';
									echo '</tr>';
								}
							?> 
						</tbody>
