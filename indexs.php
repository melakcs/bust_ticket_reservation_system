...
<div id="wrapper">
	<div id="header">
    <h1><a href="indexs.php"><img src="cooltext1082219071.png" onmouseover="this.src='cooltext1082219071MouseOver.png';" onmouseout="this.src='cooltext1082219071.png';" /></a></h1>
        <ul id="mainnav">
			<li class="current"><a href="indexs.php">Home</a></li>
    	...
    	<div id="rotator">
              ...
              <div id="logo" style="left: 600px; height: auto; top: 23px; width: 260px; position: absolute; z-index:4;">
					...
					<div class="accordion-content" style="margin-bottom: 15px;">
						<form action="SelectSetMine.php" method="post" style="margin-bottom:none;">
						<?php
						$UName=$_SESSION['usernameu'];	
						?>
						<span style="margin-right: 11px;">User Name:
                        <input type="text" name="uname" value="<?php echo $UName ?>" style="width: 165px; margin-left: 15px; border: 3px double #CCCCCC; padding:5px 10px;" readonly="readonly"/>

                        
                        
                        </span><br>
                        <span style='margin-right: 11px;'>Route: 
    <select name="route" style='width: 190px; margin-left: 15px; border: 3px double #CCCCCC; padding:5px 10px;'> 
                        <?php
						include('db.php');
...
<span style="margin-right: 11px;">Date: <input type="text" class="w8em format-d-m-y highlight-days-67 range-low-today" name="date" id="sd" value="" maxlength="10" readonly="readonly" style="width: 165px; margin-left: 15px; border: 3px double #CCCCCC; padding:5px 10px;"/></span><br><br>

								<span style="margin-right: 11px;">No. of Passenger: 
  <select name="qty" style='width: 190px; margin-left: 15px; border: 3px double #CCCCCC; padding:5px 10px;'>
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                                <option>4</option>
						...
						<input type="submit" id="submit" name="order" value="Order" style="height: 34px; margin-left: 15px; width: 191px; padding: 5px; border: 3px double rgb(204, 204, 204);" class="button" />
						</form>
					</div>
